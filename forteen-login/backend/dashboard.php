<?php
$tab_title = "Dashboard - Welcome to your panel";
?>
    ...
    <div class="row">
        <div class="col">
            <div class="page-description">
                ...
                <h3>Your ID is <?= $_SESSION['s_id'] ?></h3>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-xl-6">
            ...
            <div class="card widget widget-list">
                ...
                <div class="card-body">
                    ...
                    <ul class="widget-list-content list-unstyled" style="overflow-y: scroll; height: 340px;">
