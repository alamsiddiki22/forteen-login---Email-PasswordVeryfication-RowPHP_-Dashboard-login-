...
<body>
    ...
    // ------[avabe o unset kora jay / page ar sasha {session_unset();} likle o hoy]------
                    ...
                    <input id="password_field" type="text" class="form-control <?= (isset($_SESSION['password_error'])) ? 'is-invalid' : ''?>" placeholder="password" name="password" value="<?= (isset($_SESSION['old_password'])) ? $_SESSION['old_password'] : '' ?>" >
